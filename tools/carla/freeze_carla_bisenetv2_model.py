...
# @File    : freeze_carla_bisenetv2_model.py
# @IDE: PyCharm
"""
...
def init_args():
    ...
    parser.add_argument('--frozen_pb_file_path', type=str, help='The output frozen pb file path',
                        default='./checkpoint/bisenetv2_carla_frozen.pb')
    parser.add_argument('--optimized_pb_file_path', type=str, help='The output frozen pb file path',
                        default='./checkpoint/bisenetv2_carla_optimized.pb')
...
def load_graph_from_ckpt_file(weights_path):
    ...
    input_tensor = tf.placeholder(dtype=tf.float32, shape=[1, 256, 256, 3], name='input_tensor')
