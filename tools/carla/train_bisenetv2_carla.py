...
"""
from trainner.carla import carla_bisenetv2_single_gpu_trainner as single_gpu_trainner#, \
    #cityscapes_bisenetv2_multi_gpu_trainner as multi_gpu_trainner
from local_utils.log_util import init_logger
from local_utils.config_utils import parse_config_utils

LOG = init_logger.get_logger('train_bisenetv2_carla')
...
def train_model():
    ...
    worker = single_gpu_trainner.BiseNetV2CarlaTrainer()
