...
# @IDE: PyCharm
"""
Carla tensorflow dataset io module
"""
import os
...
from local_utils.augment_utils.carla import augmentation_tf_utils as aug

CFG = parse_config_utils.carla_cfg_v2
LOG = loguru.logger
...
class _CarlaTfWriter(object):
    ...
    def write_tfrecords(self):
        ...
        train_tfrecords_file_name = 'carla_train.tfrecords'
        ...
        val_tfrecords_file_name = 'carla_val.tfrecords'
...
class _CarlaTfReader(object):
    ...
    def __len__(self):
        ...
        :return:
        """
        tfrecords_file_paths = ops.join(self._tfrecords_dir, 'carla_{:s}.tfrecords'.format(self._dataset_flags))
...
class CarlaTfIO(object):
    ...
    def __init__(self):
        ...
        """
        self._writer = _CarlaTfWriter()
        self._train_dataset_reader = _CarlaTfReader(dataset_flag='train')
        self._val_dataset_reader = _CarlaTfReader(dataset_flag='val')
